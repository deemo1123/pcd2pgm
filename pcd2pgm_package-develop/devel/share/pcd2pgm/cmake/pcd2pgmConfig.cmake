...
if("TRUE" STREQUAL "TRUE")
  set(pcd2pgm_SOURCE_PREFIX /home/oem/pcd2pgm/pcd2pgm_package-develop/src/pcd2pgm)
  set(pcd2pgm_DEVEL_PREFIX /home/oem/pcd2pgm/pcd2pgm_package-develop/devel)
  set(pcd2pgm_INSTALL_PREFIX "")
  set(pcd2pgm_PREFIX ${pcd2pgm_DEVEL_PREFIX})
else()
  set(pcd2pgm_SOURCE_PREFIX "")
  set(pcd2pgm_DEVEL_PREFIX "")
  set(pcd2pgm_INSTALL_PREFIX /home/oem/pcd2pgm/pcd2pgm_package-develop/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pcd2pgm' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/oem/pcd2pgm/pcd2pgm_package-develop/src/pcd2pgm/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/oem/pcd2pgm/pcd2pgm_package-develop/devel/lib;/opt/ros/noetic/lib)
